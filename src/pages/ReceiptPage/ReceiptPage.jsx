    ...
    <>
        ...
        <Container>
            <Box sx={{ textAlign: 'center', mt: 4 }}>
                ...
                <Typography variant="subtitle2" sx={{ color: '#6f6f6f', fontWeight: 400 }}>Hi { 'name' }, here&apos;s your receipt.</Typography>
            </Box>
            ...
            <Box mt={4}>
                <Container sx={{ background: '#dff7fe', pt: 3, pb: 3, borderRadius: 2 }}>
                    ...
                    <br />
                    <Typography variant="caption">3rd FL #1303 Condo bldg. Brgy New Era, Dasmarinas, Cavite</Typography>
                    ...
                    <Grid container>    
                        ...
                        <Grid item xs={4}>
                            <Typography sx={{ float: 'right' }} variant="caption">₱100.00</Typography>
                        </Grid>
                    </Grid>
                    <Grid container>    
                        <Grid item xs={6}>
                        ...
                        <Grid item xs={4}>
                            <Typography sx={{ float: 'right' }} variant="caption">₱220.00</Typography>
                        </Grid>
                    </Grid>
                    ...
                    <Grid container>    
                        ...
                        <Grid item xs={3}>
                            <Typography sx={{ float: 'right' }} fontWeight={600} variant="subtitle1" color='#099DBD'>₱220.00</Typography>
                        </Grid>
                    </Grid>
                </Container>
            </Box>
